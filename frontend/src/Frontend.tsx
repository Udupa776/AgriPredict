...
const Frontend = () => {
  ...
  return (
    <div className="font-sans bg-[#f8fafc] text-slate-900 min-h-screen overflow-x-hidden selection:bg-green-200">
      ...
      {/* Navbar */}
      <nav className={`fixed top-4 left-1/2 -translate-x-1/2 z-50 transition-all duration-300 rounded-full flex items-center justify-between px-6 py-3 w-[90%] max-w-5xl ${scrolled ? 'bg-white/80 backdrop-blur-xl shadow-md border border-white/20' : 'bg-transparent'
        }`}>
