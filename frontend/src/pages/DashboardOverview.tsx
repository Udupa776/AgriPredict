...
const SB_URL = 'https://udxvbgucjueqzdwkpsqz.supabase.c';
const SB_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVkeHZiZ3VjanVlcXpkd2twc3F6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzc5NTk0MTksImV4cCI6MjA5MzUzNTQxOX0.ktJFHpOCMHgBqvTHGzoLSYaXxxiwxGnV-iUp_CUCfPo';
